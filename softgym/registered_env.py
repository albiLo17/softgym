...
from softgym.envs.cloth_fold_elas import ClothFoldElasEnv
...
env_arg_dict = {
    ...
    'ClothFold': {'observation_mode': 'cam_rgb',
                  ...
                  'use_cached_states': True,
                  'deterministic': False},
    'ClothFoldElas': {'observation_mode': 'point_cloud',
                  'action_mode': 'picker',
                  'num_picker': 1,
                  'render': True,
                  'headless': True,
    ...
    'ClothDrop': dict(observation_mode='cam_rgb',
                      ...
                      use_cached_states=True,
                      deterministic=False),
    'ClothDrag': dict(observation_mode='point_cloud',
                      action_mode='picker',
                      num_picker=2,
                      render=True,
                      headless=True,
...
SOFTGYM_ENVS = OrderedDict({
    ...
    'ClothFoldElas': ClothFoldElasEnv,
