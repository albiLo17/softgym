...
class Dragger(ActionToolBase):
    ...
    def reset(self, center):
        ...
        for (i, centered_picker_pos) in enumerate(centered_picker_pos):
            # do not modify the first element that is the box
            if i != 0:
